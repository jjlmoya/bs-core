...
function render_bs_head_circle($attributes)
{
	...
	return '
		<section class="og-banner-outside-circle 
			...
			<div class="ml-box ml-box--circle l-flex l-flex--align-center l-flex--justify-center l-flex--direction-column a-border a-border--fat a-border--primary a-mar-auto a-mar--minus-60 u-layer-0">
				<p class="a-text a-text--center a-text--xs">
					' . $claim . '
				</p>
				<h1 class="a-text  a-text--l  a-text--bold">
					' . $title . '
				</h1>
				<p class="a-text a-text--center a-text--xs">
					' . $subtitle . '
